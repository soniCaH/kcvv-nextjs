...
✅ src/app/news/[slug]/page.tsx (120 lines)
✅ src/components/news/ArticleLayout.tsx (80 lines)
✅ src/components/news/ArticleLayout.stories.tsx (60 lines)
✅ src/components/news/**tests**/ArticleLayout.test.tsx (90 lines)
✅ src/lib/effect/schemas/article.schema.ts (generated by schema-migrator)
✅ src/lib/drupal-api.ts (added getArticle method)
...
✅ Storybook Stories: 100% variants covered
...
1. ✅ Review in Storybook: `npm run storybook`
2. ✅ Run tests: `npm run test -- ArticleLayout`
3. ✅ Test page locally: visit /news/test-slug
4. ⏳ Create PR (ready when you are)
