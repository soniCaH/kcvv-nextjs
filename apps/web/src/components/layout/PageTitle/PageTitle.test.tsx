...
describe("PageTitle", () => {
  ...
  describe("Custom Props", () => {
    ...
    it("should accept custom padding", () => {
      const { container } = render(
        <PageTitle title="Test Title" padding="px-6 pt-8 pb-8" />,
      );
      const header = container.querySelector("header");
    ...
    it("should accept custom container width", () => {
      const { container } = render(
        <PageTitle title="Test Title" containerWidth="max-w-4xl" />,
      );
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle long titles", () => {
      const longTitle =
        "This is a very long page title that should still render correctly without breaking the layout or causing overflow issues";
    ...
    it("should handle empty custom className gracefully", () => {
      const { container } = render(
        <PageTitle title="Test Title" className="" />,
      );
      const header = container.querySelector("header");
