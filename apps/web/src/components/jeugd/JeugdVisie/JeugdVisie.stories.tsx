...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'The `/jeugd` filosofie/visie block (Phase 7 / 7j0b). Carries the `#visie` anchor. A mono section kicker "Onze jeugdvisie" above an ink `<PullQuote placement="section">` carrying the visie statement and a mono tag row in the `labels` slot (#2566).',
      },
    },
  },
  decorators: [
