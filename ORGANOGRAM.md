...
An interactive organizational chart (organogram) that displays the complete club structure including Hoofdbestuur and Jeugdbestuur. Built with d3-org-chart library.
...
- See GitHub issues #437-440
- Component files in `src/components/organogram/`
