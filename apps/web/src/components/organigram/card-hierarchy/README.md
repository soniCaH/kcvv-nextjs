...
```tsx
import { CardHierarchy } from "@/components/organigram/option-a/CardHierarchy";
import { clubStructure } from "@/data/club-structure";
import { MemberDetailsModal } from "@/components/organigram/MemberDetailsModal";
...
```
src/components/organigram/prototypes/option-a/
