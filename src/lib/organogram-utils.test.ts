/**
 * Tests for Organogram Utility Functions
 */
...
} from "./organogram-utils";

// Mock organogram data for testing
...
describe("buildOrganogramUrl", () => {
  it("should build URL with both member and view params", () => {
    ...
    expect(url).toBe("/club/organogram?member=president&view=chart");
  });
  ...
  it("should build URL with only member param", () => {
    ...
    expect(url).toBe("/club/organogram?member=secretary");
  });
  ...
  it("should build URL with only view param", () => {
    ...
    expect(url).toBe("/club/organogram?view=cards");
  });

  it("should return base path with no params", () => {
    const url = buildOrganogramUrl("/club/organogram", {});

    expect(url).toBe("/club/organogram");
  });
  ...
  it("should properly encode special characters in member ID", () => {
    ...
    expect(url).toBe("/club/organogram?member=member+with+spaces");
  });
});

describe("parseOrganogramParams", () => {
  it("should parse URLSearchParams with both params", () => {
    const params = new URLSearchParams("?member=president&view=chart");
    const result = parseOrganogramParams(params);
  ...
  it("should parse string with both params", () => {
    const result = parseOrganogramParams("?member=secretary&view=cards");
  ...
  it("should parse with only member param", () => {
    const result = parseOrganogramParams("?member=treasurer");
  ...
  it("should parse with only view param", () => {
    const result = parseOrganogramParams("?view=responsibilities");
  ...
  it("should return null values for empty string", () => {
    const result = parseOrganogramParams("");
  ...
  it("should handle URL-encoded characters", () => {
    const result = parseOrganogramParams("?member=member+with+spaces");
