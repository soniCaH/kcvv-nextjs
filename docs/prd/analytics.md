...
> **Single source of truth (#1974):** `scripts/analytics-taxonomy.mjs` exports the
> machine-readable taxonomy — `prefixes` (trigger regex tokens) and `params` (GA4
...
| Event name (regex) | `responsibility_\|search_\|organigram_\|related_content_\|related_article_\|article_\|event_\|player_\|match_\|team_\|clubshop_banner_\|kalender_\|sponsor_\|banner_\|nav_\|footer_\|jeugd_\|hub_\|board_\|geschiedenis_\|ultras_\|membership_\|error_\|gallery_\|empty_state_\|inhoud_` (generated by `analytics-taxonomy.mjs` `buildTriggerRegex()` — do not hand-edit; see §3 note) |
