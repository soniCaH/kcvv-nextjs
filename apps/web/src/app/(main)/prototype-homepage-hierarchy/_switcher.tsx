...
export function PrototypeSwitcher({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-4 z-50 flex justify-center px-4">
      <div className="border-cream/30 bg-ink text-cream pointer-events-auto flex max-w-full flex-col gap-2 border-2 p-2 shadow-[6px_6px_0_0_#6b6b6b]">
        ...
        <div className="flex flex-wrap gap-1">
          ...
          <button
            type="button"
            onClick={() => go("overlay", overlay ? "0" : "1")}
            className={
              overlay
                ? "bg-alert text-cream border-alert border px-2 py-1 font-mono text-[10px] tracking-wider uppercase"
                : "border-cream/40 hover:bg-cream/20 border px-2 py-1 font-mono text-[10px] tracking-wider uppercase"
            }
          >
            rangen
