...
import { UnifiedOrganogramClient } from "./UnifiedOrganogramClient";
import { clubStructure } from "@/data/club-structure";

/**
 * UnifiedOrganogramClient - Tabbed interface for organogram views
 *
 ...
 */
const meta = {
  title: "Features/Organogram/UnifiedOrganogram",
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Unified organogram interface with three view modes: Card Hierarchy, Interactive Chart, and Responsibility Finder. View preference is saved to localStorage and restored on next visit.",
      },
    },
  },
  tags: ["autodocs"],
} satisfies Meta<typeof UnifiedOrganogramClient>;
