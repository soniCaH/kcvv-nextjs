...
describe("player.schema", () => {
  describe("PlayerAttributes", () => {
    it("should decode valid player attributes", () => {
      ...
      expect(result.field_firstname).toBe("John");
      expect(result.field_lastname).toBe("Doe");
      expect(result.field_position).toBe("Midfielder");
      expect(result.field_shirtnumber).toBe(10);
    ...
    it("should decode player attributes with minimal fields", () => {
      ...
      expect(result.field_firstname).toBeUndefined();
      expect(result.field_shirtnumber).toBeUndefined();
    });
  });
  ...
  describe("Player", () => {
    it("should decode complete player entity", () => {
      ...
      expect(result.attributes.field_shirtnumber).toBe(9);
    });
  ...
  describe("PlayersResponse", () => {
    it("should decode complete players response", () => {
      ...
      expect(result.links?.self?.href).toBe(
        "https://example.com/jsonapi/node/player",
      );
  ...
  describe("PlayerResponse", () => {
    it("should decode single player response", () => {
      ...
      expect(result.data.attributes.field_shirtnumber).toBe(17);
