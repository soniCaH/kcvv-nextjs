 ...
 */
export class DrupalTermReference extends S.Class<DrupalTermReference>(
  "DrupalTermReference",
)({
  id: S.String,
  type: S.String,
 ...
 */
export class DrupalNodeReference extends S.Class<DrupalNodeReference>(
  "DrupalNodeReference",
)({
  id: S.String,
  type: S.String,
 ...
 * ```
 */
export class RelationshipMeta extends S.Class<RelationshipMeta>(
  "RelationshipMeta",
)({
  /**
   * Alt text for images
 ...
 * ```
 */
export class RelationshipReference extends S.Class<RelationshipReference>(
