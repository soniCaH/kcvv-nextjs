...
// the locked spec's "opacity 0.7" mood, but fractional cream on `bg-jersey-deep`
// gives up more contrast than the surface can spare — now the general rule, see
// DESIGN.md "The Whole-Cream Rule". If a consumer wants a softer mono label on a
// dark surface, they can wrap the label in a parent with reduced opacity rather
// than baking it into the token.
