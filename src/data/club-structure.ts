...
export const clubStructure: OrgChartNode[] = [
  ...
  // Level 1: President
  {
    ...
    responsibilities: 'Leiding geven aan het volledige bestuur, vertegenwoordigen van de club naar buiten toe, strategische beslissingen en algemene coördinatie.',
  ...
  // Level 2: Main Board Positions
  {
    ...
    positionShort: 'VP',
    department: 'hoofdbestuur',
    responsibilities: 'Ondersteunen van de voorzitter, waarnemen bij afwezigheid, specifieke projecten coördineren.',
  ...
  },
  {
    ...
    positionShort: 'SEC',
    department: 'hoofdbestuur',
    responsibilities: 'Administratie, correspondentie, verslaggeving van vergaderingen, contacten met de bond.',
  ...
  },
  {
    ...
    positionShort: 'PM',
    department: 'hoofdbestuur',
    responsibilities: 'Financieel beheer, budgettering, kascontrole, subsidies aanvragen.',
  ...
  // Level 3: Department Heads under Main Board
  {
    ...
    positionShort: 'TC',
    department: 'hoofdbestuur',
    responsibilities: 'Coördinatie van alle technische aspecten, trainersbeleid, spelerswerving, sportief beleid.',
  ...
  },
  {
    ...
    positionShort: 'INFRA',
    department: 'hoofdbestuur',
    responsibilities: 'Onderhoud terreinen, kleedkamers, kantine, materiaal, veiligheid.',
    parentId: 'vice-president',
  },
  {
    ...
    positionShort: 'SPON',
    department: 'hoofdbestuur',
    responsibilities: 'Sponsorwerving, partnerships, advertenties, sponsorcontacten onderhouden.',
  ...
  },
  {
    ...
    positionShort: 'COM',
    department: 'hoofdbestuur',
    responsibilities: 'Website, social media, nieuwsberichten, perscontacten, promotie.',
  ...
  },
  {
    ...
    positionShort: 'EVENT',
    department: 'hoofdbestuur',
    responsibilities: 'Organisatie clubactiviteiten, feesten, tornooien, recepties.',
    parentId: 'secretary',
  },
  ...
  // Level 4: Specific Roles under Departments
  {
    ...
    positionShort: 'T1',
    department: 'hoofdbestuur',
    responsibilities: 'Training en begeleiding eerste ploeg, wedstrijdvoorbereiding, selectie.',
  ...
  },
  {
    ...
    positionShort: 'T2',
    department: 'hoofdbestuur',
    responsibilities: 'Ondersteunen hoofdtrainer, specifieke trainingen, analyse.',
  ...
  },
  {
    ...
    positionShort: 'GRND',
    department: 'hoofdbestuur',
    responsibilities: 'Onderhoud velden, lijnen trekken, gras maaien, beregening.',
  ...
  },
  {
    ...
    positionShort: 'KANT',
    department: 'hoofdbestuur',
    responsibilities: 'Beheer kantine, voorraadbeheer, vrijwilligers coördineren.',
    parentId: 'infrastructure-manager',
  },
  {
    ...
    positionShort: 'SMM',
    department: 'hoofdbestuur',
    responsibilities: 'Facebook, Instagram, Twitter/X beheren, content creatie, engagement.',
  ...
  },
  {
    ...
    positionShort: 'FOTO',
    department: 'hoofdbestuur',
    responsibilities: 'Fotograferen wedstrijden en evenementen, beelden beschikbaar stellen.',
    parentId: 'communication-manager',
  },
  ...
  // Level 2: Youth Coordinator (directly under President)
  {
    ...
    responsibilities: 'Algemene leiding jeugdwerking, coördinatie jeugdbestuur, link met hoofdbestuur.',
  ...
  // Level 3: Youth Board Members
  {
    ...
    positionShort: 'TJ',
    department: 'jeugdbestuur',
    responsibilities: 'Trainersbeleid jeugd, sportieve ontwikkeling, opleiding trainers.',
  ...
  },
  {
    ...
    positionShort: 'JSEC',
    department: 'jeugdbestuur',
    responsibilities: 'Administratie jeugdwerking, inschrijvingen, mutaties, contacten bond.',
    parentId: 'youth-coordinator',
  },
  {
    id: 'youth-treasurer',
  ...
  },
  {
    ...
    positionShort: 'JEV',
    department: 'jeugdbestuur',
    responsibilities: 'Organisatie jeugdtornooien, sinterklaasfeest, eindejaarfeest, kampen.',
    parentId: 'youth-coordinator',
  },
  ...
  // Level 4: Age Category Coordinators
  {
    ...
    positionShort: 'U6-9',
    department: 'jeugdbestuur',
    responsibilities: 'Coördinatie benjamin ploegen, oudercontacten, trainersondersteuning.',
  ...
  },
  {
    ...
    department: 'jeugdbestuur',
    responsibilities: 'Coördinatie pupillen ploegen, wedstrijdplanning, ontwikkeling.',
    parentId: 'youth-technical-coordinator',
  },
  {
  ...
  // Additional specialized youth roles
  {
    ...
    positionShort: 'JMAT',
    department: 'jeugdbestuur',
    responsibilities: 'Beheer jeugdmateriaal, tenues, ballen, trainingsmaterialen.',
  ...
  },
  {
    ...
    positionShort: 'JVOL',
    department: 'jeugdbestuur',
    responsibilities: 'Coördineren ouders en vrijwilligers voor jeugdactiviteiten.',
    parentId: 'youth-secretary',
  },
]
