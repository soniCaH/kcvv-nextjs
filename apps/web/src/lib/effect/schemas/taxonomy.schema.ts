 ...
 */
export class TaxonomyTermRelationships extends S.Class<TaxonomyTermRelationships>(
 ...
 * ```
 */
export class TaxonomyTermsResponse extends S.Class<TaxonomyTermsResponse>(
