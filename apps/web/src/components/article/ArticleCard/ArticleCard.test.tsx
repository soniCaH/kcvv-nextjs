...
describe("ArticleCard", () => {
  ...
  describe("Image Rendering", () => {
    ...
    it("should have correct image container classes", () => {
      const { container } = render(
        <ArticleCard {...defaultProps} imageUrl="/images/test.jpg" />,
      );
  ...
  describe("Metadata Rendering", () => {
    ...
    it("should render both date and tags", () => {
      ...
      render(
        <ArticleCard {...defaultProps} date="15 januari 2025" tags={tags} />,
      );
      expect(screen.getByText("15 januari 2025")).toBeInTheDocument();
      expect(screen.getByText("#Nieuws")).toBeInTheDocument();
    });
    ...
    it("should render clock icon with date", () => {
      const { container } = render(
        <ArticleCard {...defaultProps} date="15 januari 2025" />,
      );
    ...
    it("should render tags icon with tags", () => {
      const tags = [{ name: "Nieuws" }];
      const { container } = render(
        <ArticleCard {...defaultProps} tags={tags} />,
      );
  ...
  describe("Custom Props", () => {
    it("should accept custom className", () => {
      const { container } = render(
        <ArticleCard {...defaultProps} className="custom-card" />,
      );
  ...
  describe("Edge Cases", () => {
    it("should handle long titles with line clamping", () => {
      const longTitle =
        "This is a very long article title that should be clamped to two lines and show ellipsis when it exceeds the available space";
  ...
  describe("Hover Effects", () => {
    it("should have group class for hover coordination", () => {
      const { container } = render(
        <ArticleCard {...defaultProps} imageUrl="/test.jpg" />,
      );
      const article = container.querySelector("article");
  ...
  describe("Integration", () => {
    ...
    it("should work with full props", () => {
      ...
      expect(
        screen.getByText("KCVV Elewijt behaalt belangrijke overwinning"),
      ).toBeInTheDocument();
      expect(screen.getByAltText("Match photo")).toBeInTheDocument();
      expect(screen.getByText("15 januari 2025")).toBeInTheDocument();
      expect(screen.getByText("#Nieuws")).toBeInTheDocument();
