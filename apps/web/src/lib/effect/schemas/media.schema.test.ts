...
describe("Media Schema", () => {
  describe("MediaImageAttributes", () => {
    ...
    it("should parse minimal media image attributes", () => {
      ...
      const result =
        S.decodeUnknownSync(MediaImageAttributes)(minimalAttributes);
  ...
  describe("MediaImageRelationships", () => {
    it("should parse media image relationships with file reference", () => {
      ...
      const result = S.decodeUnknownSync(MediaImageRelationships)(
        validRelationships,
      );
    ...
    it("should accept any type value (validation happens at included resource level)", () => {
      ...
      if (
        result.field_media_image?.data &&
        "type" in result.field_media_image.data
      ) {
  ...
  describe("MediaImage", () => {
    ...
    it("should reject invalid type literal", () => {
      ...
      expect(() =>
        S.decodeUnknownSync(MediaImage)(invalidMediaImage),
      ).toThrow();
    });
