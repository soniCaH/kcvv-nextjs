...
describe("TeamHeader", () => {
  ...
  describe("Season Stats", () => {
    it("should render wins, draws, losses", () => {
      render(
        <TeamHeader name="A-Ploeg" stats={{ wins: 12, draws: 5, losses: 3 }} />,
      );
      expect(screen.getByText("12")).toBeInTheDocument();
      expect(screen.getByText("5")).toBeInTheDocument();
      expect(screen.getByText("3")).toBeInTheDocument();
      expect(screen.getByText("Winst")).toBeInTheDocument();
      expect(screen.getByText("Gelijk")).toBeInTheDocument();
    ...
    it("should render position when provided", () => {
      render(
        <TeamHeader
          name="A-Ploeg"
          stats={{ wins: 12, draws: 5, losses: 3, position: 2 }}
        />,
      );
    ...
    it("should render goals for and against when provided", () => {
      ...
      expect(screen.getByText("Voor")).toBeInTheDocument();
