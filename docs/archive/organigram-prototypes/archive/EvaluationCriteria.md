# Organigram UX Redesign - Evaluation Criteria

**Project:** Organigram Prototype Comparison
**Date:** 2025-01-01
...
1. Move from `prototypes/option-a/` to main `organigram/` folder
...
1. Remove old `OrganigramClient.tsx`
