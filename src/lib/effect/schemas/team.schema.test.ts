...
describe('team.schema', () => {
  describe('TeamAttributes', () => {
    it('should decode valid team attributes', () => {
      ...
      expect(result.field_team_id).toBe(1001)
    ...
    it('should decode team attributes with minimal fields', () => {
      ...
      expect(result.field_team_id).toBe(1)
    })
  })
  ...
  describe('Team', () => {
    it('should decode complete team entity', () => {
      ...
      expect(result.attributes.field_team_id).toBe(1002)
    })
  ...
  describe('TeamsResponse', () => {
    it('should decode complete teams response', () => {
      ...
      expect(result.links?.self?.href).toBe('https://example.com/jsonapi/node/team')
      expect(result.links?.next?.href).toBe('https://example.com/jsonapi/node/team?page[offset]=10')
