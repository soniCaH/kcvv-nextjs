...
export const Default: Story = {
  render: () => (
    <>
      <FeaturedArticles articles={mockFeaturedArticles} autoRotate={true} autoRotateInterval={5000} />
      <LatestNews articles={mockLatestNews} title="Laatste nieuws" showViewAll={true} viewAllHref="/news" />
    </>
  ),
}
...
export const SlowRotation: Story = {
  render: () => (
    <>
      <FeaturedArticles articles={mockFeaturedArticles} autoRotate={true} autoRotateInterval={8000} />
      <LatestNews articles={mockLatestNews} title="Laatste nieuws" showViewAll={true} viewAllHref="/news" />
    </>
  ),
}
...
export const CustomTitle: Story = {
  render: () => (
    <>
      <FeaturedArticles articles={mockFeaturedArticles} autoRotate={true} autoRotateInterval={5000} />
      <LatestNews articles={mockLatestNews} title="Recente berichten" showViewAll={true} viewAllHref="/news" />
    </>
  ),
}
...
export const Minimal: Story = {
  render: () => (
    <>
      <FeaturedArticles articles={mockFeaturedArticles.slice(0, 1)} autoRotate={false} />
      <LatestNews articles={mockLatestNews.slice(0, 3)} title="Laatste nieuws" showViewAll={true} viewAllHref="/news" />
    </>
  ),
}
