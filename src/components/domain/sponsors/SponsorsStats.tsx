...
export const SponsorsStats = ({ totalSponsors, className }: SponsorsStatsProps) => {
  return (
    <div className={cn('text-center py-12 px-6', className)}>
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-lg text-gray-500 max-w-2xl mx-auto">
          Samen maken we voetbal mogelijk. Dankzij de steun van onze sponsors kunnen we blijven investeren in onze
          club, onze jeugd en onze toekomst.
        </p>
      </div>
    </div>
  )
