  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <section className="mb-12">
        ...
        <p className="mb-4 text-sm text-kcvv-gray">
          Font stack: montserrat, -apple-system, system-ui, BlinkMacSystemFont,
          Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif
        </p>

        <div className="space-y-4">
          <p style={{ fontFamily: "var(--font-family-body)", fontWeight: 400 }}>
            Normal (400): The quick brown fox jumps over the lazy dog. KCVV
            Elewijt is een voetbalclub met stamnummer 55. Er is maar één
            plezante compagnie! 0123456789
          </p>

          <p style={{ fontFamily: "var(--font-family-body)", fontWeight: 500 }}>
            Medium (500): The quick brown fox jumps over the lazy dog. KCVV
            Elewijt is een voetbalclub met stamnummer 55. Er is maar één
            plezante compagnie! 0123456789
          </p>

          <p style={{ fontFamily: "var(--font-family-body)", fontWeight: 700 }}>
            Bold (700): The quick brown fox jumps over the lazy dog. KCVV
            Elewijt is een voetbalclub met stamnummer 55. Er is maar één
            plezante compagnie! 0123456789
          </p>
        </div>
      ...
      <section className="mb-12">
        ...
        <p className="mb-4 text-sm text-kcvv-gray">
          Font stack: stenciletta, -apple-system, system-ui, BlinkMacSystemFont,
          Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif
        </p>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-kcvv-gray">
            Used for decorative/display text
          </p>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <p className="mb-4 text-sm text-kcvv-gray">
          Font stack: ibm-plex-mono, Consolas, Liberation Mono, Courier,
          monospace
        </p>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-kcvv-gray">
            Used for match scores and statistics
          </p>
