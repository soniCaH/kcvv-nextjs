...
const Content = ({
  ...
  useEffect(() => {
    const checkAlignment = () => {
      ...
      setAlignLeft(center < viewportWidth / 2);
    };
  ...
  return (
    <motion.div
      ...
      } top-[calc(100%_+_24px)] w-96 rounded-lg border border-neutral-600 bg-gradient-to-b from-neutral-900 via-neutral-900 to-neutral-800 p-4`}
    >
      <Bridge />
    ...
    <div>
      <div className="grid grid-cols-2 gap-2">
        ...
        <a href="#">
          <Image
            className="mb-2 h-14 w-full rounded object-cover"
            src="https://placehold.co/200x56.jpg"
            alt="Placeholder image"
            width={200}
            height={56}
          />
