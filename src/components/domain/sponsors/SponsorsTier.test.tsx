...
describe('SponsorsTier', () => {
  describe('Rendering', () => {
    it('renders with gold tier styling', () => {
      const { container } = render(<SponsorsTier tier="gold" title="Gold Sponsors" sponsors={mockSponsors} />)
    ...
    it('renders with silver tier styling', () => {
      const { container } = render(<SponsorsTier tier="silver" title="Silver Sponsors" sponsors={mockSponsors} />)
    ...
    it('renders with bronze tier styling', () => {
      const { container } = render(<SponsorsTier tier="bronze" title="Bronze Sponsors" sponsors={mockSponsors} />)
    ...
    it('renders all sponsors', () => {
      render(<SponsorsTier tier="gold" title="Test Sponsors" sponsors={mockSponsors} />)
    ...
    it('returns null when sponsors array is empty', () => {
      const { container } = render(<SponsorsTier tier="gold" title="Empty" sponsors={[]} />)
  ...
  describe('Links', () => {
    it('renders sponsors with URLs as links', () => {
      ...
      const link1 = screen.getByLabelText('Bezoek website van Sponsor One').closest('a')
  ...
  describe('Images', () => {
    ...
    it('renders images with correct dimensions for gold tier', () => {
      render(<SponsorsTier tier="gold" title="Test" sponsors={[mockSponsors[0]]} />)
    ...
    it('renders images with correct dimensions for silver tier', () => {
      render(<SponsorsTier tier="silver" title="Test" sponsors={[mockSponsors[0]]} />)
    ...
    it('renders images with correct dimensions for bronze tier', () => {
      render(<SponsorsTier tier="bronze" title="Test" sponsors={[mockSponsors[0]]} />)
  ...
  describe('Styling', () => {
    it('applies custom className', () => {
      const { container } = render(
        <SponsorsTier tier="gold" title="Test" sponsors={mockSponsors} className="custom-class" />
      )
  ...
  describe('Accessibility', () => {
    it('has proper heading hierarchy', () => {
      render(<SponsorsTier tier="gold" title="Gold Sponsors" sponsors={mockSponsors} />)
    ...
    it('has aria-label for clickable sponsors', () => {
      ...
      expect(screen.getByLabelText('Bezoek website van Sponsor One')).toBeInTheDocument()
      expect(screen.getByLabelText('Bezoek website van Sponsor Three')).toBeInTheDocument()
    })
