...
const meta = {
  title: 'Domain/Sponsors/SponsorsTier',
...
export const GoldTier: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Gold tier with 4-column layout (responsive: 2 cols mobile, 3 cols tablet, 4 cols desktop)',
      },
    },
  },
}
...
export const SilverTier: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Silver tier with 5-column layout (responsive: 2 cols mobile, 4 cols tablet, 5 cols desktop)',
      },
    },
  },
}
...
export const BronzeTier: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Bronze tier with 6-column layout (responsive: 2 cols mobile, 4 cols tablet, 6 cols desktop)',
      },
    },
  },
}
...
export const SingleSponsorComparison: Story = {
  ...
  render: () => (
    <div className="space-y-8">
      <SponsorsTier tier="gold" title="Gold (280px)" sponsors={[mockSponsors[0]]} />
      <SponsorsTier tier="silver" title="Silver (200px)" sponsors={[mockSponsors[1]]} />
      <SponsorsTier tier="bronze" title="Bronze (160px)" sponsors={[mockSponsors[2]]} />
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story: 'Comparison of image sizes across different tiers: Gold (280px), Silver (200px), Bronze (160px)',
      },
    },
  },
}
...
export const MixedLinks: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Some sponsors have URLs (clickable) while others do not (non-clickable)',
      },
    },
  },
}
...
export const FullSponsorsPage: Story = {
  ...
  render: () => (
    <div className="max-w-inner-lg mx-auto p-6 space-y-8">
      <h1 className="text-3xl font-bold text-kcvv-gray-blue mb-8">Sponsors KCVV Elewijt</h1>
      <SponsorsTier tier="gold" title="Gouden Sponsors" sponsors={mockSponsors.slice(0, 4)} />
      <SponsorsTier tier="silver" title="Zilveren Sponsors" sponsors={mockSponsors.slice(4, 8)} />
      <SponsorsTier tier="bronze" title="Bronzen Sponsors" sponsors={mockSponsors.slice(0, 10)} />
    </div>
  ),
  parameters: {
    layout: 'fullscreen',
