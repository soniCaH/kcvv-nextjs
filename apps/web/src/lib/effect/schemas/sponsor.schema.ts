 ...
 */
export const SponsorType = S.Literal(
  "crossing",
  "training",
  "white",
  "green",
 ...
 */
export class SponsorAttributes extends S.Class<SponsorAttributes>(
  "SponsorAttributes",
)({
  ...BaseDrupalNodeAttributes,
 ...
 */
export class SponsorRelationships extends S.Class<SponsorRelationships>(
 ...
 * ```
 */
export class SponsorsResponse extends S.Class<SponsorsResponse>(
  "SponsorsResponse",
)({
  data: SponsorsArray,
 ...
 * ```
 */
export class SponsorResponse extends S.Class<SponsorResponse>(
  "SponsorResponse",
)({
  data: Sponsor,
  included: S.optional(S.Array(SponsorIncludedResource)), // ✅ Strongly typed
