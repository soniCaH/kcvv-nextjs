...
export const SponsorsEmptyState = ({ className }: SponsorsEmptyStateProps) => {
  return (
    <div className={cn('text-center py-16 px-6', className)}>
      ...
      {/* Message */}
      <h3 className="text-2xl font-bold text-kcvv-gray-blue mb-4">Nog geen sponsors beschikbaar</h3>
      <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
        We zijn op zoek naar partners die onze club willen steunen. Word één van de eerste sponsors en
        versterk uw zichtbaarheid in de regio!
      </p>
