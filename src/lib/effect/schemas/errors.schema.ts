 ...
 */
export class FootbalistoError extends S.TaggedError<FootbalistoError>()('FootbalistoError', {
  message: S.String,
  status: S.optional(S.Number),
  cause: S.optional(S.Unknown),
}) {}
 ...
 * Timeout error
 */
export class TimeoutError extends S.TaggedError<TimeoutError>()('TimeoutError', {
  message: S.String,
